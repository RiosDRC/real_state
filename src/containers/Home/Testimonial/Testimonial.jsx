...
const Testimonial = () => {
  ...
  return (
    <div className='app__home-testimonial' ref={elementRef}>
      <div className="app__home-testimonial_left">
        <div>
      ...
      <div className={`app__home-testimonial_right ${isVisible ? 'scale-in-center' : ''}`}/>
    </div>
  )
}
