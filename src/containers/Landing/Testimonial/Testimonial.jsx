...
const Testimonial = () => {
  ...
  return (
    <div className='app__landing-testimonial' ref={elementRef}>
      <div className="app__landing-testimonial_left">
        <div>
      ...
      <div className={`app__landing-testimonial_right ${isVisible ? 'scale-in-center' : ''}`}/>
    </div>
  )
}
